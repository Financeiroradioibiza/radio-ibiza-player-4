...
3. [ ] TWA em **`mobile/`** (já existe — Bubblewrap); após SHA-256 da Play, copiar `assetlinks` de **`mobile/play-store/assetlinks.json.example`** para **`public/.well-known/assetlinks.json`** e fazer deploy.
